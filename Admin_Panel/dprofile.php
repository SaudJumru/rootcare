...
$sql = "SELECT * FROM user_table WHERE Is_Doctor='1'"; // Modify 'your_table_name' with the actual table name
                    ...
                    <div class="profile-view">
                        <div class="profile-img-wrap">
                            <div class="profile-img">
                                <a href="#"><img class="avatar" src="assets/img/doctor-thumb-06.jpg" alt=""></a>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="profile-info-left">
                                        <h3 class="user-name m-t-0 mb-0"><?php echo $row['Fname']; ?></h3>
                                        <div class="staff-id">Employee ID : <?php echo $row['User_ID']; ?></div>
                                    </div>
                                </div>
                                <div class="col-md-7">
                                    <ul class="personal-info">
                                        <li>
                                            ...
                                            <span class="text"><a href="#"><?php echo $row['Mobile_No']; ?></a></span>
                                        </li>
                                        <li>
