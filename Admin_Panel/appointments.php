                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <!-- <td><img width="28" height="28" src="assets/img/user.jpg" class="rounded-circle m-r-5" alt=""> <?php //echo $row['User_ID']; ?></td> -->
...
<?php
                                        // Delete modal for each appointment
                                                echo "<div id='delete_service_".$row["Appointment_ID"]."' class='modal fade delete-modal' role='dialog'>";
                                                ...
                                                echo "<a href='delete-appointments.php?id=".$row['Appointment_ID']."' class='btn btn-danger'>Delete</a>";
                                                echo "</div>";
                                                echo "</div>";
                                                echo "</div>";
                                                echo "</div>";
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <?php echo "<a href='delete-appointments.php?id=".$row['Appointment_ID']."' class='btn btn-white'>Delete</a>";?>
