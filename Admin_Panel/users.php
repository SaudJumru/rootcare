            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-4 col-3">
                        <h4 class="page-title">Users Detail</h4>
                    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped custom-table">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                <!-- <td><?php //echo $row['Appointment_ID']; 
                                                            ?></td> -->
                                                <!-- <td><img width="28" height="28" src="assets/img/user.jpg" class="rounded-circle m-r-5" alt=""> <?php //echo $row['User_ID']; 
                                                                                                                                                    ?></td> -->
                                                <td><img width="28" height="28" src="assets/img/user.jpg" class="rounded-circle m-r-5" alt=""> <?php echo $row['Fname']; ?></td>
                                                ...
                                                <?php
                                                // Delete modal for each appointment
                                                echo "<div id='delete_service_" . $row["User_ID"] . "' class='modal fade delete-modal' role='dialog'>";
                                                ...
                                                echo "<a href='delete-users.php?id=" . $row['User_ID'] . "' class='btn btn-danger'>Delete</a>";
                                                echo "</div>";
                                                echo "</div>";
                                                echo "</div>";
                                                echo "</div>";
                                                ...
                                                <td class="text-right">
                                                    <div class="dropdown dropdown-action">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            <?php echo "<a href='delete-users.php?id=" . $row['User_ID'] . "' class='btn btn-white'>Delete</a>"; ?>
