...
$sql1 = "SELECT COUNT(*) AS Total_Doctors FROM user_table WHERE Is_Doctor='1'";
$res1 = $conn->query($sql1);
if ($res1) {
    $row1 = $res1->fetch_assoc();
    // Access the total doctors count
...
$sql2 = "SELECT COUNT(User_ID) AS Total_Patients FROM user_table WHERE Is_Patient='1'";
...
$sql3 = "SELECT COUNT(*) AS Total_Users FROM user_table";
...
$sql4 = "SELECT COUNT(*) AS total_services FROM services_table"; // Note the variable name here: total_services
$res4 = $conn->query($sql4);

if ($res3) {
    $row = $res4->fetch_assoc();
    $total_services = $row['total_services']; // Corrected variable name
} else {
    $total_services = 0;
}

$sql = "SELECT COUNT(*) AS total_appointments FROM appointment_table";
$res = $conn->query($sql);
...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="assets/img/teeth.png">
...
<body>
    ...
    <div class="dash-widget">
        ...
        <div class="dash-widget-info text-right">
            <!-- Display the dynamic count of appointments -->
            <h3><?php echo $total_patients; ?></h3> <!-- Correct variable name -->
            <span class="widget-title1">Patients <i class="fa fa-check" aria-hidden="true"></i></span>
                    ...
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                        <div class="dash-widget">
                        <span class="dash-widget-bg1"><i class="fa-regular fa-user"></i></span>
                    ...
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                        <div class="dash-widget">
                            <span class="dash-widget-bg1"><i class="fa fa-calendar"></i></span>
                            <div class="dash-widget-info text-right">
                                <!-- Display the dynamic count of appointments -->
                                <h3><?php echo $total_appointments; ?></h3> <!-- Correct variable name -->
                    ...
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                        <div class="dash-widget">
                            <span class="dash-widget-bg1"><i class="fa fa-plus-square"></i></span>
                            <div class="dash-widget-info text-right">
                                <!-- Display the dynamic count of appointments -->
                                <h3><?php echo $total_services; ?></h3> <!-- Correct variable name -->
                                <span class="widget-title1">Services <i class="fa fa-check" aria-hidden="true"></i></span>
                            </div>
                        </div>
                    </div>
                </div>
