...
// $sql2 = "SELECT COUNT(*) AS Total_Users FROM user_table WHERE Is_Admin='1' AND Is_Doctor='1' AND Is_Patient='1'";
$sql2 = "SELECT COUNT(Email) AS Total_Users FROM user_table";
...
if ($res) {
    $row = $res->fetch_assoc();
    // Access the total appointments count
